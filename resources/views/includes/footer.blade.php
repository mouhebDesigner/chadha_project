<footer class="footer-div theme-1">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="footer-text">
                        <p>Nulla justo neque, tincidunt id bibendum a, rhoncus et eros. Vestibulum commodo diam ut risus
                            pulvinar consequat vitae a dui. Vivamus sed molestie diam. Maecenas vitae enim lacus.</p>
                    </div>
                    <div class="helpline">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <address class="company-address">
                        ...
                        <p class="m-b-8">Fax : Service@carrgo.com</p>
                    </address>
                </div>
                <div class="col-lg-3 col-sm-6">
    ...
    <div class="copyright-div">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <p>© Copyright 2021 by Tortoiz. All Right Reserved.</p>
                </div>
                <div class="col-lg-6">
                    <ul class="social-nav">
